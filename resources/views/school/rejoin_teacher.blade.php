            ...
            <li class="mb-1">
                ...
                <div class="collapse show" id="teacher-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        ...
                        <li class="active"><a href="/school/rejoin_teacher">Rejoin</a></li>
                    </ul>
                </div>
            </li>
            <li class="mb-1">
        ...
        <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
                <tr>
                    ...
                    <th>
                        <i class="fa-regular fa-circle-check h4 text-success" style="cursor: pointer;"></i>
                        <i class="fa-regular fa-circle-xmark h4 text-danger" style="cursor: pointer;"></i>
                    </th>
                </tr>
            </tbody>
        </table>
