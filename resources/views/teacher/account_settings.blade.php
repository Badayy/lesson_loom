            ...
            <li class="mb-1">
                ...
                <div class="collapse show" id="setting-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        ...
                        <li class="active"><a href="/teacher/account_settings">Account Settings</a></li>
                    </ul>
                </div>
            </li>
            <li class="mb-1">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 mb-5">
                                ...
                                <div>
                                    <span><i>Secure your account by updating your password.</i></span>
                            ...
                            <div class="col-12 mb-5">
                                ...
                                <div>
                                    <span><i>Modify other details like your address, phone number, and other contact information to keep your profile up to date.</i></span>
